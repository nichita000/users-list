...
/* harmony import */ var _store_store_module__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./store/store.module */ "./src/app/store/store.module.ts");
/* harmony import */ var _components_cards_container_cards_container_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./components/cards-container/cards-container.component */ "./src/app/components/cards-container/cards-container.component.ts");
...
var stompConfig = {
    url: _environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].websocketConnectUrl,
    headers: {},
    heartbeat_in: 0,
    heartbeat_out: 0,
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            declarations: [
                ...
                _components_cards_container_cards_container_component__WEBPACK_IMPORTED_MODULE_11__["CardsContainerComponent"],
            ...
            imports: [
                ...
                _store_store_module__WEBPACK_IMPORTED_MODULE_10__["StoreModule"],
                _ngrx_store_devtools__WEBPACK_IMPORTED_MODULE_9__["StoreDevtoolsModule"].instrument({ maxAge: 21 }),
...
/* harmony import */ var _store_reducers_index__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../store/reducers/index */ "./src/app/store/reducers/index.ts");
...
var CardsContainerComponent = /** @class */ (function () {
    ...
    CardsContainerComponent.prototype.ngOnInit = function () {
        ...
        this.$participants = this._store.select(_store_reducers_index__WEBPACK_IMPORTED_MODULE_2__["getParticipants"]);
    };
...
var ParticipantsSocketService = /** @class */ (function () {
    function ParticipantsSocketService(_stompService) {
        ...
        this.participantsEventRoute = '/topic/messages';
    }
...
var ParticipantsService = /** @class */ (function () {
    ...
    ParticipantsService.prototype.participantsList = function () {
        var url = _environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].baseHref + "/participants";
...
var environment = {
    production: false,
    websocketConnectUrl: 'ws://89.223.27.70/ws',
    baseHref: 'http://89.223.27.70'
};
